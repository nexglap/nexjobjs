...
class AdminService {
  ...
  private defaultSettings: AdminSettings = {
    apiUrl: 'https://staging.nexjob.tech/wp-json/wp/v2',
    filtersApiUrl: 'https://staging.nexjob.tech/wp-json/nex/v1/filters-data',
    authToken: '',
    siteTitle: 'Nexjob - Find Your Dream Job',
    siteDescription: 'Platform pencarian kerja terpercaya di Indonesia dengan ribuan lowongan dari perusahaan terbaik',
    homeTitle: 'Nexjob - Temukan Karir Impianmu',
    homeDescription: 'Platform pencarian kerja terpercaya di Indonesia dengan ribuan lowongan dari perusahaan terbaik',
    jobsTitle: 'Lowongan Kerja - Nexjob',
    jobsDescription: 'Temukan lowongan kerja terbaru dari berbagai perusahaan terpercaya di Indonesia',
    articlesTitle: 'Tips & Panduan Karir - Nexjob',
